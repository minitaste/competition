# Generated by Django 4.2.7 on 2025-02-01 18:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teams', models.ManyToManyField(blank=True, related_name='tournaments', to='api.team')),
            ],
        ),
        migrations.AddField(
            model_name='team',
        ...
        migrations.AddField(
            model_name='team',
            name='players',
            field=models.ManyToManyField(blank=True, related_name='teams', to='api.user'),
        ),
        migrations.CreateModel(
            name='Statistic',
            fields=[
